      ...
      <div style="opacity: 1; transform: none;">
        <div class="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-2">
            ...
            <ul role="list" class="grid grid-cols-2 gap-8 sm:grid-cols-3">
              <li>
                ...
                <ul role="list" class="mt-4 text-sm text-neutral-700">
                  <li class="mt-4"><a class="transition hover:text-neutral-950" href="/work/family-fund">FamilyFund</a>
                  </li>
                  ...
                  <li class="mt-4"><a class="transition hover:text-neutral-950" href="/work">See all <span
              ...
              <li>
                ...
                <ul role="list" class="mt-4 text-sm text-neutral-700">
                  ...
                  <li class="mt-4"><a class="transition hover:text-neutral-950" href="https://github.com">GitHub</a>
                  </li>
          ...
          <div class="flex lg:justify-end">
            <form class="max-w-sm"><h2 class="font-display text-sm font-semibold tracking-wider text-neutral-950">Sign
              up for our newsletter</h2>
              <p class="mt-4 text-sm text-neutral-700">Subscribe to get the latest design news, articles, resources and
                inspiration.</p>
        ...
        <div
          ...
          <a aria-label="Home" href="/">
            <svg viewBox="0 0 130 32" aria-hidden="true" class="group/logo h-8">
              <svg viewBox="0 0 32 32" aria-hidden="true" preserveAspectRatio="xMinYMid meet">
                <rect clip-path="url(#:r54:-clip)"
                      class="h-8 transition-all duration-300 fill-neutral-950 w-0 group-hover/logo:w-8"></rect>
                <use href="#:r54:-path" class="stroke-neutral-950" fill="none" stroke-width="1.5"></use>
                <defs>
                  <path id=":r54:-path"
                  ...
                  <clipPath id=":r54:-clip">
                    <use href="#:r54:-path"></use>
                  </clipPath>
                </defs>
              </svg>
          ...
          <p class="text-sm text-neutral-700">© Studio Agency Inc. 2024</p></div>
      </div>
    </div>
  </footer>
</template>
