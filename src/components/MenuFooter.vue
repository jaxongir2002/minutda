...
<template>
  <div class="mx-auto max-w-2xl lg:max-w-none">
    <div class="grid grid-cols-1 gap-y-10 pb-16 pt-10 sm:grid-cols-2 sm:pt-16">
      <div>
        <h2 class="font-display text-base font-semibold text-white">{{t('ourOffice')}}</h2>
        <ul role="list" class="mt-6 grid grid-cols-1 gap-8 sm:grid-cols-2">
          <li>
            <address class="text-sm not-italic text-neutral-300"><strong
                class="text-white">{{t('samarkand')}}</strong><br>{{t('address')}}<br>
            </address>
          </li>
<!--          <li>-->
<!--            <address class="text-sm not-italic text-neutral-300"><strong-->
<!--                class="text-white">Billund</strong><br>24 Lego Allé<br>7190, Billund, Denmark-->
<!--            </address>-->
<!--          </li>-->
        </ul>
      </div>
      <div class="sm:border-l sm:border-transparent sm:pl-16"><h2
          class="font-display text-base font-semibold text-white">{{t('followUs')}}</h2>
        <ul role="list" class="flex gap-x-10 text-white mt-6">
          <li><a aria-label="Facebook" class="transition hover:text-neutral-200" href="https://facebook.com">
          ...
          <li><a aria-label="Instagram" class="transition hover:text-neutral-200"
                 href="https://www.instagram.com/justmedia_uz?igsh=MTNtbTdleHM4N2kxaw%3D%3D&utm_source=qr">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-current">
              <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <li><a aria-label="LinkedIn" class="transition hover:text-neutral-200" href="https://www.linkedin.com/company/minutda-llc/posts/?feedView=all">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-current">
              <path fill-rule="evenodd" clip-rule="evenodd"
                    d="M20.452 20.452h-3.554v-5.746c0-1.371-.027-3.134-1.91-3.134-1.91 0-2.202 1.492-2.202 3.033v5.847H9.232V9h3.415v1.561h.048c.476-.9 1.635-1.846 3.364-1.846 3.598 0 4.263 2.368 4.263 5.448v6.289ZM5.337 7.433a2.062 2.062 0 1 1 0-4.123 2.062 2.062 0 0 1 0 4.123ZM6.898 20.452H3.775V9h3.123v11.452ZM22.225 0H1.771C.79 0 0 .784 0 1.75v20.495C0 23.216.79 24 1.771 24h20.454C23.21 24 24 23.216 24 22.245V1.75C24 .784 23.21 0 22.225 0Z"></path>
            </svg>

          </a></li>
          <li><a aria-label="Dribbble" class="transition hover:text-neutral-200" href="https://dribbble.com">
            <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-current">
              <path fill-rule="evenodd" clip-rule="evenodd"
